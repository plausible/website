...
Stats API, embed dashboard and the proxy are all available during the trial. If you also require access to the sites API and need more than 10 websites (which is the limit of our regular Business plan), please do contact us to discuss an enterprise plan.
