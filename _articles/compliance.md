...
cta_headline: "Ready to start your free trial?"
---
...
- **[Data Processing Agreement (DPA)](https://plausible.io/dpa)**: covers GDPR obligations, processor responsibilities, data location, breach notification (48-hour obligation) and subprocessor controls. Applies to all customers automatically.
- **[Privacy policy](https://plausible.io/privacy)**: how Plausible handles data related to account holders.
- **[Terms of service](https://plausible.io/terms)**: the contract governing use of Plausible.
- **[Imprint](https://plausible.io/imprint)**: legal entity details, company registration and registered address.

## Data handling

- **[Data policy](https://plausible.io/data-policy)**: what Plausible collects from your website visitors, how it is stored, and the technical method used to count unique visitors without cookies or personal data.
- **[Subprocessors](https://plausible.io/privacy#subprocessors)**: the third-party services Plausible uses to operate and what data each handles.

## Security

- **[Security overview](https://plausible.io/security)**: technical and organizational security measures including infrastructure, access controls, encryption, backups, monitoring and software update practices.
- **[Vulnerability disclosure program](https://plausible.io/vulnerability-disclosure-program)**: how to report security vulnerabilities and how they are handled.
- **[Open source code](https://github.com/plausible/analytics/)**: Plausible's source code is publicly available for independent audit.

## Infrastructure and availability

- **[EU hosting](https://plausible.io/eu-hosted-web-analytics)**: which infrastructure providers are used, where data is stored and what this means for GDPR compliance.
- **[Status and uptime](https://status.plausible.io)**: current and historical uptime for all Plausible services.
