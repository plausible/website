...
| **Premium features** | All features available as listed in [our pricing plans](https://plausible.io/#pricing). | Selected premium features such as funnels and [ecommerce revenue goals](https://plausible.io/blog/ecommerce-revenue-attribution) are not available as we aim to ensure a protective barrier around our cloud offering.|
