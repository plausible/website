...
| **Premium features** | All features available as listed in [our pricing plans](https://plausible.io/#pricing). | Selected premium features such as [marketing funnels](https://plausible.io/docs/funnel-analysis) and [ecommerce revenue goals](https://plausible.io/docs/ecommerce-revenue-tracking) are not available as we aim to ensure [a protective barrier around our cloud offering](https://plausible.io/blog/community-edition).|
