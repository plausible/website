...
These Terms apply to Plausible Analytics Cloud. Self-hosted usage is governed by the applicable open source license.
...
For our free trial, we explain the length of trial when you sign up. We do not ask for your credit card. After the trial period, you need to pay in advance to keep using the service. If you do not pay, we may suspend or restrict access to your account until payment is made.
...
Paying customers are billed automatically via supported payment methods.
...
Our payment process is handled by Paddle, which also manages customer service inquiries and returns. Applicable taxes may be added at checkout. Paddle collects and remits those taxes to the relevant authorities. See [Paddle's Terms of Use](https://www.paddle.com/legal/terms) for details.
...
We reserve the right to suspend or terminate your account and refuse any current or future use of the service for any reason at any time. Such termination will result in the deactivation or deletion of your account or access to your data. Plausible Analytics reserves the right to refuse service to anyone for any reason at any time.
...
Sometimes we change the pricing structure for our products. When we do that, we tend to exempt existing customers from those changes. However, we may choose to change prices for existing customers. If we do so, we will give at least 30 days notice via email.
...
You are solely responsible for any content and other material that you submit, publish, transmit, email or display through the service.

You may provide feedback and suggestions about the service. You agree that we may use and incorporate your feedback without restriction or compensation.

You must not modify another website to falsely imply association with Plausible Analytics. The service is protected by copyright and trademark laws. You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the service without permission.
...
You entrust us with your site data and we take that trust seriously. You agree that Plausible Analytics may process your data as described in our [data policy](https://plausible.io/data-policy).
...
We do not collect or store personal data about your website visitors that can be used to identify individuals, and we do not use behavioral data for advertising purposes.

Each party agrees to handle the other party’s data in accordance with applicable laws and appropriate security measures.

You agree not to use the service to send sensitive information such as credit card numbers, government identifiers, financial account information, real-time geolocation or other highly sensitive personal data.

---

## General conditions

Your use of Plausible Analytics is at your sole risk. The service is provided on an “as is” and “as available” basis.
...
Authorized personnel may access your data where necessary to provide support, maintain the service and ensure security.

We use third party vendors to provide infrastructure, storage, payment processing and related services. More details are available in our [Privacy Policy](https://plausible.io/privacy) and [Data Processing Agreement](https://plausible.io/dpa).

---

## Liability

To the maximum extent permitted by law, Plausible Analytics shall not be liable for any indirect, incidental, special, consequential or exemplary damages, including loss of profits, data or goodwill.

This agreement is governed by the laws of Estonia and disputes will be handled in Estonian courts.

---

## Contact us

If you have a question about these Terms of Service, please [contact us](https://plausible.io/contact).
