...
description: Why Plausible stays independent, avoids selling data, and is funded
...
So far as financial success is concerned: The simple math is that if a company makes a few million in annual profit and has low costs, the team behind it is financially secure. That we are, so we do not need an exit to be successful by today’s definitions.
...
* Calm work culture (4 day work weeks, no meetings, etc., FTW)
