...
## 4. It's a liability considering GDPR, CCPA and other privacy regulations
...
## 5. It uses cookies so you must obtain consent to store cookies
...
## 6. It' blocked by many plugins and browsers so the data is not very accurate
...
## 7. It requires an extensive privacy policy
