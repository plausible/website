...
[The definition](http://www.awstats.org/docs/awstats_glossary.html) for "pages" metric according to AWStats is: "The number of "pages" viewed by visitors".
...
Despite these efforts, it seems to miss out on a lot of bot traffic. This seems to be a general issue with server log analysis as a whole rather than issue with AWStats software itself.
