...
We're a completely independent, self-funded and bootstrapped team of four. We're intentionally small, profitable and sustainable. We still don't have any paid advertising budget either.
...
We've had a wild, roller-coaster journey. It took us 324 days to reach the first $400 monthly recurring revenue (MRR) after we launched the paid subscriptions SaaS business in May 2019.
...
Indie Hackers is a wonderful, supportive community and a perfect place to start your "build in public" journey. Take a look at [our Indie Hackers profile](https://www.indiehackers.com/product/plausible-insights) and start reading from the oldest post first to better understand how we progressed.

### May: Paid subscriptions launched ($64 MRR)

We launched our paid subscription plans. A piece of widespread startup advice is to charge more. An important consideration for us was that Google Analytics is free of charge, and people are not used to paying for web analytics. The paid alternatives on the market started at high rates.

To incentivize more site owners to ditch Google, we wanted to offer fair and affordable prices. And so we kicked off with a reasonably priced entry point to give owners of smaller sites a chance to de-Google.

We had 60 active beta users at that point, and some decided to stick around and pay for the product. We ended the month with our first paying subscribers and $64 MRR.
...
The post was not related to our product and niche, so the benefits were not that great, but it was still lovely to get a spike in traffic. This was our first venture into content marketing and going "viral".

We're bootstrapped without any advertising budget, so trying to get heard by writing blog posts was the obvious way to go. Content marketing and Hacker News continue to be essential to us to this day. Most people that hear about Plausible hear about us thanks to some of the content we've published and word of mouth through social media and different communities.

### August ($142 MRR)

### September: Embracing the open source world ($178 MRR)

Plausible goes fully open source with the MIT license, and all the code is publicly available on [GitHub](https://github.com/plausible/analytics/). Our repository includes all of the code powering our SaaS with nothing hidden.

We did this to be as transparent as possible and to give people more control over their data. Going open source is a great way to build trust in a privacy-first world.

Plausible continues being fully open source software, and we've since made it possible to self-host our analytics on your server too.
...
This other person was me. Uku cold-emailed me after reading a blog post I published about [how to degoogle a website](https://markosaric.com/degoogleify/). I thought he built a great product with great potential in a market I was familiar with, so I was in.

Running, developing and growing a startup in a competitive market such as web analytics is challenging. Uku could now focus entirely on the design and development of the product, while I could take care of the marketing, community management and customer support.
...
I remember looking at the stats on our Plausible dashboard; we had 49 visitors in total, and 0 from Google search the day before I joined. My first tiny goal was to get ten organic visitors from Google search daily.

We may be going against Google Analytics, but Google search is still what most people use to search the web, so we needed to start having a presence in the relevant results pages for Plausible to grow organically.

My first few weeks were spent on:
...
* streamlining the communication to send a consistent message everywhere (as an example, previously, we used the name Plausible Insights some places while Plausible Analytics other places)
...
* adding a lot of new product-related content (each main area of focus got one article, we published a comparison with Google Analytics etc.)

There's an overview of this period and my actions in [this post](https://plausible.io/blog/blog-post-changed-my-startup).

### April: Picking up a fight and going viral ($607 MRR)

On April 8th, I published my first Plausible blog post. Our new positioning was based on how different we are compared to Google Analytics, and we decided to pick a fight.

The post went to the top of Hacker News, and it helped us spread the word about Plausible. More than 25,000 people visited our site when we published the post. We broke all our records in April: the most traffic, trials and the biggest MRR increase.
...
May started great as on the 1st day of the month. We ended up being featured on OpenSource.com as [a transparent and open source alternative to Google Analytics](https://opensource.com/article/20/5/plausible-analytics). We got 94 new trials on May 2nd, which is our best day for the number of new trial signups.

This opportunity came as part of the outreach we did to different websites. Most websites ended up ignoring our emails. It isn't easy to send so many emails and hear nothing back, but this one outstanding feature was worth all that silence.

We also posted [our first tweet](https://twitter.com/PlausibleHQ/status/1262317156697546752) on May 18th with the message that "Friends don't let friends use Google Analytics".

We have a 30-day free trial, so it took some time to see the results from April's viral post in our MRR. We doubled our MRR during the month and ended on $1,055 MRR.

### June: Moving the database to ClickHouse ($1,767 MRR)

With all the new trials and customers, and an increase in large websites using the service, Plausible became much slower to use. To continue our growth, we needed to improve. We [moved from our PostgreSQL database to ClickHouse](https://plausible.io/blog/may-2020-recap) to make the app much faster and handle much bigger clients.

Moving to ClickHouse was the best technical decision, and we're now counting more than one billion page views per month while still having a fast-loading dashboard.

### July: Once again on the top of Hacker News ($2,844 MRR)

We got our second Hacker News moment when our post on "[how to pay your rent with your open source project](https://plausible.io/blog/open-source-funding)" brought us more than 35,000 visitors in one day.

This is a topic that's dear to our hearts. We'd love to see more competitive open source alternatives to the products made by surveillance capitalism. And the only way to achieve that is to get more people to work full-time on open source software.

I published an overview of our marketing activities and top referral sources of traffic: [How we grew our startup from $400 to $2,750 MRR in 135 days without ads](https://plausible.io/blog/startup-marketing).

### August: Product Hunt launch ($4,062 MRR)

We launched on Product Hunt. This is typically a big event for all startups. Product Hunt was worthwhile, but it's not our core growth strategy, so it was just another day for us. We didn't put all of our eggs in this one basket.

Launching on community sites gives your project a spotlight for a few days, but it's not a sustainable channel to acquire customers in the long term—that famous spike of hope after which follows the flat line of nope.

As far as we're concerned, launches like this are nice, but they're not necessary for continued growth. Here's [how not to launch on Product Hunt (and lessons from our successful launch)](https://plausible.io/blog/product-hunt-launch).

### September: Paid out our first salaries ($5,035 MRR)

On September 10th, we paid the first salaries for the two of us. Even though our wages didn't match what we could command on the job market, we were thrilled to see a green entry on the bank account, paid from our open source project. Pretty wild. It feels great to pay our rent from an open source project.
...
We needed to research the different licenses to find one that fits our needs. I'm pretty new to the open source world, so I ended up learning about AGPL a few days before we officially made the switch.
...
Running a managed cloud service and opening the code for self-hosting seems to be a great model for open source projects. Read more: [Lessons from building and growing an open source SaaS](https://plausible.io/blog/building-open-source).
...
Robert joined us part-time while finishing his computer science degree as the third team member. Robert is helping us with the technical customer support, and he's getting familiar with the Plausible code base to help us with development.
...
It's exciting times to be a European, privacy-focused web analytics project. Plausible exclusively uses EU-owned cloud infrastructure, which made us a good fit for those organizations where Google Analytics no longer allowed them to fulfill the legal requirements that apply to them.
...
It's not only the news from European data protection authorities that were great for us. Google tried to help push alternative solutions too.

Google announced they'd kill Universal Analytics and that there's no way to import historical stats to the new GA4 version. We've experienced an immediate increase in interest in Plausible following this news. March was our best month, with $8,247 in net MRR growth.
...
We have tried to proactively react to these external happenings to seize the opportunity when it presents itself. We worked hard to be the well-positioned alternative to Google Analytics both from the privacy and Universal Analytics/GA4 perspectives.

We introduced [an import tool that allows you to bring your old Google Analytics stats](https://plausible.io/docs/google-analytics-import) into Plausible. Google may not want you to import your old stats into their new product, but we're happy to.

We also have a realtime dashboard and a landing page report which many Google Analytics users are unhappy about with their Google Analytics experience. This has helped us become an excellent alternative to an increasing number of sites unhappy with Google's approach.
...
Our marketing strategy has been remarkably similar throughout all the milestones. It's not based on shouting, interrupting or tricking people. It's a boring strategy and doesn't feature exciting growth hacks.
...
And this is how we plan to continue from here on as well. Trying to be as ethical as possible in our marketing and communication is crucial to us, and I hope we can continue growing without using any of the "[best marketing practices](https://plausible.io/blog/best-marketing-practices)":
...
In addition to this, we make it very easy to cancel a subscription at any time. No need to contact ask. No questions are asked. We also inform people in advance before their annual subscription is up for renewal, so they have a chance to cancel before it happens in case they no longer find Plausible useful. There are also no surprise fees, and we never charge anyone unexpectedly.
